...
def guide_matrix_parts() -> str:
    ...
    # rollup, and back to "four" when that rollup table was removed as a
    # duplicate of it (both 2026-09-16). The marker is a literal on both sides
    # on purpose: a regex here would keep matching while the walkthrough
    # drifted.
